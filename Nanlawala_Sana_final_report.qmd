...
the [LSAC National Longitudinal Bar Passage Study](https://eric.ed.gov/?id=ED469370) completed in 1998 by
...
[Law School Admissions Council (LSAC)](https://www.lsac.org/blog/incoming-class-2022-major-advance-diversity-more-work-to-do), the incoming class of 2022 had
...
Law school tier ranked from 1-6 (6 being the highest) was established by clusers 1-6 according to undergraduate GPAS and LSAT scores. Below shows the general distribution of applicants and their law school. 

![](plots/law_tier_distribution.png)
Most students attended schools that were ranked either 3 or 4, with the lowest number of students attending schools ranked 1. 

#### *Family Income and Law School Tier:*
Another interesting exploration was to compare family income ranges with the law school tiers that the students attended. (again, the law schools were ranked by and undefined analysis of undergraduate GPA and LSAT scores)

![](plots/fam_inc_tier_distribution.png)
While the law school tiers directly reference the scores and GPAs, it is a general conclusion that more prestigious universities accept students with higher LSAT scores and GPAs, meaning they would rank higher on the list. By family income, the most students who attended law schools ranked 6 were of the fifth family income range while the most students who attended law schools ranked 1 were of the first family income range. 
...
### Bar Exam Attempts:
For those did pass the bar exam, data was collected on when they passed the bar (as in, which attempt did they pass). This data can be seen in the table below: 
...
![](plots/lsat_bar_attempt.png)
More people with a higher LSAT score passed the bar exam on their first try. And those who did not pass the bar consisted of people with a lower LSAT score.

### Undergraduate GPA: 
As always, the GPA scale in 1991 ran on a 4 point scale. It was interesting point of exploration to see how the undergraduate GPAs of 1991 of law school students compare to law school students today. 
...
The median undergraduate GPA for students entering law school in 1991 was 3.2. This number, unsurprisingly is less than the median GPAs in recent years. According to [U.S. News,](https://www.usnews.com/education/best-graduate-schools/top-law-schools/applying/articles/what-is-a-good-college-gpa-for-a-law-school-applicant#:~:text=Among%20the%20191%20ranked%20law,GPA%20is%20much%20higher%20%E2%80%93%203.86.) the median GPA for law school students entering in 2021 was 3.55. 

#### *Undergraduate GPA and Bar Exam Attempt*
Following the distribution of undergraduate GPAs it felt necessary to compare it to bar exam passes, specificaly the attempts at passing the bar exam.

![](plots/ugpa_bar_attempt.png)
The results are similar to that of the distribution comparing LSAT scores with the bar exam attempts. More people with a higher undergraduate GPA passed the bar exam on their first try. And those who did not pass the bar consisted of people with a lower GPA. 

# [Conclusion]{.underline}
Overall, this study took a turn in focusing on demographic variables in its EDA. Some conclusions that were drawn from this EDA was the lack of racial diversity in law school students in 1991, with white students being nearly 84% of the population in this study. For black and hispanic law school students in this study, the majority were in the third family income range (and also having the most students in the first family income range).

Family income was another important venue of exploration in this study, as law school generally is a big financial investment. Most of the students in this study belonged in the second highest family income range. There was no significant pattern between fulltime and parttime students and their family income. Law school tiers, which was ranked from 1-6 (based on clusters of undergraduate GPAs and LSAT scores) was another good comparison with family income. The most students who attended law schools ranked 6 were of the fifth family income range while the most students who attended law schools ranked 1 were of the first family income range.

Unsurprisingly, there were students who did not graduate law school after entering in the fall of 1991. Of those that did not graduate, 89 students still tried for the bar exam (likely in states that allowed for this pursuit) 65 passed the bar exam. LSAT scores and undergraduate GPAs followed a similar trend with students attempting the bar, as those with higher undergraduate GPAs and LSAT scores were the majority of the group of students who bassed the bar exam on their first try. As the scores and GPA's got smaller, the students were more likely to pass on the second attempt or not at all. 

For future studies, comparisons between recent studies on law students today and this study would be beneficial to understand the changes. This should also include creating a concrete method of converting the raw LSAT score range used in 1991 to the ranges today, somehow accounting for the changes in test difficulty as well. After some extensive research, many argued their was little worth in trying to convert the values. Another variable to research for might be personal income, as many might not be financially supported by their families and might even be taking out loans for their law school education. 
