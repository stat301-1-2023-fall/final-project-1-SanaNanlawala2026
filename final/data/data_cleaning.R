...
#data
RAW_bar_pass_prediction <- read_csv("data/bar_pass_prediction.csv")

CLEAN_bar_pass_prediction <- RAW_bar_pass_prediction |> 
...
CLEAN_bar_pass_prediction <- CLEAN_bar_pass_prediction |> 
...
CLEAN_bar_pass_prediction$fulltime <- ifelse(CLEAN_bar_pass_prediction$fulltime == 1, "yes", "no")

CLEAN_bar_pass_prediction$pass_bar <- ifelse(CLEAN_bar_pass_prediction$pass_bar == 1, "yes", "no")
